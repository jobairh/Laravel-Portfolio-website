...
{{--                <h1 class="top-banner-subtitle2 text-justify">মোট সার্ভিস নিয়েছে ২০০ জন </h1>--}}
                <a target="_blank" href="https://www.youtube.com/channel/UCSMFY8_rooijS-Zv43tKCrQ"><img class="" src="{{ asset('frontEndAsset') }}/images/playbtn.svg"></a>
            </div>
        </div>
        <div class="col-md-6">
            <img  class="top-banner-img  animated fadeIn" src="{{ asset('frontEndAsset') }}/images/bannerImg.png">
        </div>
    </div>
</div>
